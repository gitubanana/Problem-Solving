...
<p style="text-align: center;"><img alt="" src="" style="width: 116px; height: 110px;"></p>

<p>and the machine executes the instruction <code>PUSH -11</code>, the stack looks like this afterwards:</p>

<p style="text-align: center;"><img alt="" src="" style="width: 117px; height: 156px;"></p>
...
<p style="text-align: center;"><img alt="" src="" style="width: 116px; height: 156px;"></p>
...
<p style="text-align: center;"><img alt="" src="" style="width: 117px; height: 108px;"></p>
...
<p style="text-align: center;"><img alt="" src="" style="width: 115px; height: 106px;"></p>

<p>and the machine executes the instruction <code>LOAD</code>, the stack looks like this afterwards</p>

<p style="text-align: center;"><img alt="" src="" style="width: 118px; height: 153px;"></p>
...
<p style="text-align: center;"><img alt="" src="" style="width: 114px; height: 152px;"></p>

<p>and the machine executes the instruction <code>PLUS</code>, the stack looks like this afterwards:</p>

<p style="text-align: center;"><img alt="" src="" style="width: 116px; height: 105px;"></p>
...
<p style="text-align: center;"><img alt="" src="" style="width: 121px; height: 153px;"></p>
