# [Gold IV] On Average They're Purple - 21189 

[문제 링크](https://www.acmicpc.net/problem/21189) 

### 성능 요약

메모리: 7352 KB, 시간: 44 ms
...
### 입력 
 ...
 <p>The first line contains two integer values $N$ and $M$ with $2 \le N \le 100\,000$ and $1 \le M \le 100\,000$. The next $M$ lines contain two integers $a_i$ and $b_i$ indicating an undirected edge between nodes $a_i$ and $b_i$ ($1 \le a_i, b_i \le N$, $a_i \not= b_i$).</p>
